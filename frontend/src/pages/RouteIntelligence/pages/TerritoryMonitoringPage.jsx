...
const FALLBACK_ROUTE_BOUNDARIES = [
  { id: 'rb-1', name: 'Alwarpet',        color: '#3b82f6', coordinates: [[13.0300, 80.2440], [13.0380, 80.2440], [13.0380, 80.2540], [13.0300, 80.2540]], dp: 'Rajan Kumar', customers: 18, compliance: 94, status: 'active' },
  { id: 'rb-2', name: 'Egmore',          color: '#10b981', coordinates: [[13.0680, 80.2550], [13.0780, 80.2550], [13.0780, 80.2660], [13.0680, 80.2660]], dp: 'Suresh Babu', customers: 14, compliance: 88, status: 'active' },
  ...
  { id: 'rb-8', name: 'Nungambakkam',   color: '#14b8a6', coordinates: [[13.0550, 80.2340], [13.0650, 80.2340], [13.0650, 80.2450], [13.0550, 80.2450]], dp: 'Vijay Sethu', customers: 22, compliance: 95, status: 'active' },
  { id: 'rb-9', name: 'Royapettah',     color: '#f97316', coordinates: [[13.0450, 80.2540], [13.0550, 80.2540], [13.0550, 80.2650], [13.0450, 80.2650]], dp: 'Saravanan',   customers: 17, compliance: 82, status: 'active' },
  { id: 'rb-10', name: 'T-Nagar',         color: '#84cc16', coordinates: [[13.0360, 80.2280], [13.0460, 80.2280], [13.0460, 80.2390], [13.0360, 80.2390]], dp: 'Manikandan',  customers: 25, compliance: 98, status: 'active' },
];
